...
// is the third-from-last arg (created_at and traffic_class are appended after it).
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 60, "arg-type table must include session_id and traffic_class")
	...
	// session_id is followed by created_at and traffic_class.
