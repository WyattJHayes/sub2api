...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	...
	log := &service.UsageLog{
		...
		CreatedAt:                 createdAt,
		TrafficClass:              service.TrafficClassUnknown,
	}
	...
	if trafficClass.Valid {
		log.TrafficClass = service.NormalizeTrafficClass(trafficClass.String)
	}
