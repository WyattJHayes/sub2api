...
// v25 includes both the group model_allowlist schema and the evaluation-key,
// free_openai_fast, and codex_models_manifest_config authorization snapshot fields.
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		IsEvaluation: apiKey.IsEvaluation,
