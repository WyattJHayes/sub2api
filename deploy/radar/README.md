...
The v0.1.176 upgrade rehearsal and isolated trial procedure is documented in
`deploy/radar/v01176-upgrade-runbook.md`. Run
`bash deploy/radar/rehearse-v01176-migrations.sh` against a disposable restore
before using any candidate digest in staging.
