#!/usr/bin/env python3
"""Build and record immutable Sub2API v0.2.8 Radar private GHCR candidates."""
...
_BASE.APP_VERSION = "0.2.8"
_BASE.SCHEMA_VERSION = "radar-v028-image-record-v1"
_BASE.IMAGE_TAG_RE = re.compile(r"^0\.2\.8-radar-v28-(\d{8}T\d{6}Z)$")
