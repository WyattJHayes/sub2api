...
MIGRATION_MANIFEST_DIR=${RADAR_MIGRATION_MANIFEST_DIR:-$ROOT_DIR/deploy/radar/manifests/v0.2.1}
...
MIGRATION_DUPLICATE_ALIASES=${RADAR_MIGRATION_DUPLICATE_ALIASES:-$MIGRATION_MANIFEST_DIR/duplicate-aliases.json}
...
run_migration_ledger() {
    ...
    python3 "$MIGRATION_LEDGER_TOOL" \
        ...
        --duplicate-aliases "$MIGRATION_DUPLICATE_ALIASES" \
        --actual "$actual" \
        --output "$output"
}
